...
__version__ = "3.200.3"
__author__ = "Guerrilla Warfare"
__copyright__ = "GWFL - Modified"
__contributors__ = ["GWF"]
...
IGNORE_ANCHORS = True # Display only text of links.
IGNORE_IMAGES = True # Display only text of images.
